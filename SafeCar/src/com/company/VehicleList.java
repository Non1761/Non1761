...
public class VehicleList extends  JFrame implements ActionListener {
    ...
    JTable table = new JTable(data, new Object[]{"ID","Type","Manufacturer","Series", "Number", "VIN", "Owner Name", "Owner Surname"});
    ...
    public VehicleList(){
        ...
        vehicleDAO.fillVehicle();
        vehicles.setText(vehicleDAO.getAllVehicle());
        ...
        add(viewService);
        viewService.setBounds(400,50,150,28);
        viewService.setFont(new Font("Calibri", Font.PLAIN, 15));
        ...
        add(searchButton);
        searchButton.setBounds(1370,50,100,28);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == addVehicle){
            ...
            try{
                Object[][] searchData = vehicleDAO.search(search.getText());

                tableSearch = new JTable(searchData, new Object[]{"ID","Type","Manufacturer","Series", "Number", "VIN", "Owner Name", "Owner Surname"});
